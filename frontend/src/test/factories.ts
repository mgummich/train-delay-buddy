...
type Summary    = paths['/journeys/{id}/summary']['get']['responses']['200']['content']['application/json']
type Leg        = NonNullable<paths['/journeys/{id}/legs']['get']['responses']['200']['content']['application/json']['legs']>[number]
type Stop       = NonNullable<paths['/journeys/{id}/legs']['get']['responses']['200']['content']['application/json']['stops']>[number]
